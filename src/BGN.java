...
public class BGN {
    /**
     * @ClassName: PublicKey
     * @Description: This is a class for storing the public key (n,G,GT,e,g,h) of
     *               BGN PKE.
     */
    ...
    /**
     * @Title: keyGeneration
     * @Description: This function is responsible for generating the public keys and
     *               the private keys.
     * @param k the security parameter, which decides the length of two large prime
     *          (p and q).
     * @return void
     */
    ...
    /**
     * @Title: encrypt
     * @Description: This function is to encrypt the message m, m in [0,1,2,...,T],
    ...
    public static int decrypt(Element c, PublicKey pubkey, PrivateKey prikey) throws Exception {
        ...
        throw new Exception("BGN.decrypt(Element c, PublicKey pubkey,PrivateKey prikey): "
                + "plaintext m is not in [0,1,2,...," + T + "]");
    }
