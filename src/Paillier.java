...
public class Paillier {
    /**
     * @ClassName: PublicKey
     * @Description: This is a class for storing the public key (n, g) of Paillier
     *               PKE.
     */
    ...
    /**
     * @Title: keyGeneration
     * @Description: This function is to help generate the public key and private
     *               key for encryption and decryption.
     * @param k k is the security parameter, which decides the length of two large
     *          primes (p and q).
     * @return void
     */
    ...
    /**
     * @Title: encrypt
     * @Description: This function is to encrypt the message with Paillier’s public
     *               key.
     * @param m      The message.
    ...
    public static BigInteger encrypt(BigInteger m, PublicKey pubkey) throws Exception {
        ...
        if (!belongToZStarN(m, n)) {
            throw new Exception("Paillier.encrypt(BigInteger m, PublicKeypubkey): plaintext m is notin Z*_n");
        }
    ...
    /**
     * @Title: decrypt
     * @Description: This function is to decrypt the ciphertext with the public key
     *               and the private key.
     * @param c      The ciphertext.
     * @param pubkey The public key of Paillier PKE.
     * @param prikey The private key of Paillier PKE.
     * @return BigInteger The plaintext.
     * @throws Exception If the cipher is not in Z*_(n^2), there is an exception.
     */
    public static BigInteger decrypt(BigInteger c, PublicKey pubkey, PrivateKey prikey) throws Exception {
        ...
        if (!belongToZStarNSquare(c, nsquare)) {
            throw new Exception("Paillier.decrypt(BigInteger c, PrivateKeyprikey): ciphertext c is not in Z*_(n^2)");
        }
    ...
    /**
     * @Title: mul
     * @Description: The function supports the homomorphic multiplication with one
    ...
    /**
     * @Title: selfBlind
     * @Description: The function supports the homomorphic self-blinding with one
     *               ciphertext and one random number.
     * @param c      The ciphertext.
    ...
    /**
     * @Title: Lfunction
     * @Description: This function is the L function which is defined by Paillier
     *               PKE, L(mu)=(mu-1)/n.
     ...
     * @Description: This function is to test whether the ciphertext is in Z*_(n^2).
     * @param c       The ciphertext.
     * @param nsquare nsquare=n^2.
     * @return boolean If it is true, the ciphertext is Z*_(n^2), otherwise, not.
     */
    ...
    public static void main(String[] args) {
        ...
        if (decrypted_m.compareTo(m) == 0) {
            System.out.println("Encryption and Decryptiontest successfully.");
        }
